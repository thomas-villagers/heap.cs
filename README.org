...
\begin{tikzpicture}[>=latex]
  ...
  \draw[fill=blue!40](5,1.1) rectangle (8,1.8);
  \draw[fill=blue!40](8,1.1) rectangle (10,1.8);
  \draw[fill=blue!40](10,1.1) rectangle (13,1.8);
  \draw[fill=blue!40](3,2.1) rectangle (8,2.8);
  \draw[fill=blue!40](8,2.1) rectangle (14,2.8);
  \draw[fill=blue!40](4,3.1) rectangle (6,3.8);
  \draw[fill=blue!40](6,3.1) rectangle (13,3.8);
  \draw[fill=blue!40](4,4.1) rectangle (12,4.8);
  \draw[fill=blue!40](4,5.1) rectangle (10,5.8);
  \draw[fill=blue!40](5,6.1) rectangle (11,6.8);
  \draw[fill=blue!40](7,7.1) rectangle (12,7.8);
  \draw[fill=blue!40](7,8.1) rectangle (15,8.8);
  \draw[fill=blue!40](9,9.1) rectangle (15,9.8);
  \draw[fill=blue!40](9,10.1) rectangle (10,10.8);
  \draw[fill=blue!40](9,11.1) rectangle (16,11.8);
  \draw[thick,->](-0.2,0.8) -- ++(0,12);
    \draw(-0.4, 1.5) node[left]{Machine 1} -- ++ (0.4,0);
    \draw(-0.4, 2.5) node[left]{Machine 2} -- ++ (0.4,0);
    \draw(-0.4, 3.5) node[left]{Machine 3} -- ++ (0.4,0);
    ...
    \draw(-0.4, 10.5) node[left]{Machine 10} -- ++ (0.4,0);
    \draw(-0.4, 11.5) node[left]{Machine 11} -- ++ (0.4,0);
  \draw[thick,->](-0.2,0.8) -- ++(17,0) node[right]{time};
    \draw(1, 0.6) node[below]{1} -- ++ (0,0.4);
    \draw(2, 0.6) node[below]{2} -- ++ (0,0.4);
    \draw(3, 0.6) node[below]{3} -- ++ (0,0.4);
    \draw(4, 0.6) node[below]{4} -- ++ (0,0.4);
